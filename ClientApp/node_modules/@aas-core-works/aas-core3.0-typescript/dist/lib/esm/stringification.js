 ...
 */
export function modelTypeToString(value) {
 ...
 */
export function mustModelTypeToString(value) {
  const result = MODEL_TYPE_TO_STRING.get(value);
  if (result === undefined) {
...
const MODELLING_KIND_FROM_STRING = new Map([["Template", AasTypes.ModellingKind.Template], ["Instance", AasTypes.ModellingKind.Instance]]);
 ...
 */
export function modellingKindFromString(text) {
  const result = MODELLING_KIND_FROM_STRING.get(text);
  return result !== undefined ? result : null;
}
const MODELLING_KIND_TO_STRING = new Map([[AasTypes.ModellingKind.Template, "Template"], [AasTypes.ModellingKind.Instance, "Instance"]]);
 ...
 */
export function modellingKindToString(value) {
 ...
 * if the `value` is invalid
 */
export function mustModellingKindToString(value) {
  const result = MODELLING_KIND_TO_STRING.get(value);
  if (result === undefined) {
...
const QUALIFIER_KIND_FROM_STRING = new Map([["ValueQualifier", AasTypes.QualifierKind.ValueQualifier], ["ConceptQualifier", AasTypes.QualifierKind.ConceptQualifier], ["TemplateQualifier", AasTypes.QualifierKind.TemplateQualifier]]);
 ...
 */
export function qualifierKindFromString(text) {
  const result = QUALIFIER_KIND_FROM_STRING.get(text);
  return result !== undefined ? result : null;
}
const QUALIFIER_KIND_TO_STRING = new Map([[AasTypes.QualifierKind.ValueQualifier, "ValueQualifier"], [AasTypes.QualifierKind.ConceptQualifier, "ConceptQualifier"], [AasTypes.QualifierKind.TemplateQualifier, "TemplateQualifier"]]);
 ...
 */
export function qualifierKindToString(value) {
 ...
 * if the `value` is invalid
 */
export function mustQualifierKindToString(value) {
  const result = QUALIFIER_KIND_TO_STRING.get(value);
  if (result === undefined) {
...
const ASSET_KIND_FROM_STRING = new Map([["Type", AasTypes.AssetKind.Type], ["Instance", AasTypes.AssetKind.Instance], ["NotApplicable", AasTypes.AssetKind.NotApplicable]]);
 ...
 */
export function assetKindFromString(text) {
  const result = ASSET_KIND_FROM_STRING.get(text);
  return result !== undefined ? result : null;
}
const ASSET_KIND_TO_STRING = new Map([[AasTypes.AssetKind.Type, "Type"], [AasTypes.AssetKind.Instance, "Instance"], [AasTypes.AssetKind.NotApplicable, "NotApplicable"]]);
 ...
 */
export function assetKindToString(value) {
 ...
 * if the `value` is invalid
 */
export function mustAssetKindToString(value) {
  const result = ASSET_KIND_TO_STRING.get(value);
  if (result === undefined) {
 ...
 */
export function aasSubmodelElementsToString(value) {
 ...
 * if the `value` is invalid
 */
export function mustAasSubmodelElementsToString(value) {
  const result = AAS_SUBMODEL_ELEMENTS_TO_STRING.get(value);
  if (result === undefined) {
...
const ENTITY_TYPE_FROM_STRING = new Map([["CoManagedEntity", AasTypes.EntityType.CoManagedEntity], ["SelfManagedEntity", AasTypes.EntityType.SelfManagedEntity]]);
...
const ENTITY_TYPE_TO_STRING = new Map([[AasTypes.EntityType.CoManagedEntity, "CoManagedEntity"], [AasTypes.EntityType.SelfManagedEntity, "SelfManagedEntity"]]);
 ...
 */
export function entityTypeToString(value) {
 ...
 * if the `value` is invalid
 */
export function mustEntityTypeToString(value) {
  const result = ENTITY_TYPE_TO_STRING.get(value);
  if (result === undefined) {
...
const DIRECTION_FROM_STRING = new Map([["input", AasTypes.Direction.Input], ["output", AasTypes.Direction.Output]]);
 ...
 */
export function directionFromString(text) {
  const result = DIRECTION_FROM_STRING.get(text);
  return result !== undefined ? result : null;
}
const DIRECTION_TO_STRING = new Map([[AasTypes.Direction.Input, "input"], [AasTypes.Direction.Output, "output"]]);
 ...
 */
export function directionToString(value) {
 ...
 * if the `value` is invalid
 */
export function mustDirectionToString(value) {
  const result = DIRECTION_TO_STRING.get(value);
  if (result === undefined) {
...
const STATE_OF_EVENT_FROM_STRING = new Map([["on", AasTypes.StateOfEvent.On], ["off", AasTypes.StateOfEvent.Off]]);
 ...
 */
export function stateOfEventFromString(text) {
  const result = STATE_OF_EVENT_FROM_STRING.get(text);
  return result !== undefined ? result : null;
}
const STATE_OF_EVENT_TO_STRING = new Map([[AasTypes.StateOfEvent.On, "on"], [AasTypes.StateOfEvent.Off, "off"]]);
 ...
 */
export function stateOfEventToString(value) {
 ...
 * if the `value` is invalid
 */
export function mustStateOfEventToString(value) {
  const result = STATE_OF_EVENT_TO_STRING.get(value);
  if (result === undefined) {
...
const REFERENCE_TYPES_FROM_STRING = new Map([["ExternalReference", AasTypes.ReferenceTypes.ExternalReference], ["ModelReference", AasTypes.ReferenceTypes.ModelReference]]);
 ...
 */
export function referenceTypesFromString(text) {
  const result = REFERENCE_TYPES_FROM_STRING.get(text);
  return result !== undefined ? result : null;
}
const REFERENCE_TYPES_TO_STRING = new Map([[AasTypes.ReferenceTypes.ExternalReference, "ExternalReference"], [AasTypes.ReferenceTypes.ModelReference, "ModelReference"]]);
 ...
 */
export function referenceTypesToString(value) {
 ...
 * if the `value` is invalid
 */
export function mustReferenceTypesToString(value) {
  const result = REFERENCE_TYPES_TO_STRING.get(value);
  if (result === undefined) {
 ...
 */
export function keyTypesToString(value) {
 ...
 * if the `value` is invalid
 */
export function mustKeyTypesToString(value) {
  const result = KEY_TYPES_TO_STRING.get(value);
  if (result === undefined) {
 ...
 */
export function dataTypeDefXsdToString(value) {
 ...
 * if the `value` is invalid
 */
export function mustDataTypeDefXsdToString(value) {
  const result = DATA_TYPE_DEF_XSD_TO_STRING.get(value);
  if (result === undefined) {
 ...
 */
export function dataTypeIec61360ToString(value) {
 ...
 * if the `value` is invalid
 */
export function mustDataTypeIec61360ToString(value) {
  const result = DATA_TYPE_IEC_61360_TO_STRING.get(value);
  if (result === undefined) {
