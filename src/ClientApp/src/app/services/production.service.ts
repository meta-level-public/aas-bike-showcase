...
import { HandoverDocumentationResponse, ProducedProductRequest, ProductionResponse } from '../model/production-dtos';
...
export class ProductionService {
  ...
  testHandoverDocumentation(): Observable<HandoverDocumentationResponse> {
    return this.http.get<HandoverDocumentationResponse>(`${this.baseUrl}/TestHandoverDocumentation`);
  }
}
